          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-9 h-9 rounded-full bg-[var(--panel)] border border-[var(--border)] flex items-center justify-center text-[var(--muted)] hover:text-[var(--text)] hover:border-[var(--border-bright)] transition-all"
              >
